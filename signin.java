...
public class Signup extends JFrame implements ActionListener{
    ...
    if (!email.endsWith("@gmail.com")) {
        JOptionPane.showMessageDialog(null, "Enter a valid Gmail address ending with @gmail.com", "Invalid Email", JOptionPane.WARNING_MESSAGE);
        return;
    }

    // Pincode validation - must be exactly 6 digits
    if (!pincode.matches("\\d{6}")) {
        JOptionPane.showMessageDialog(null, "Pincode must be exactly 6 digits", "Invalid Pincode", JOptionPane.WARNING_MESSAGE);
        return;
    }
